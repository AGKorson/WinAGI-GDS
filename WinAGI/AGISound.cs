...
namespace WinAGI.Engine
{
  ...
  {
    AGITrack[] mTrack = new AGITrack[4];
    bool mTracksSet;
    double mLength;
    int mKey;
    int mTPQN;
    ...
    public AGISound() : base(AGIResType.rtSound, "NewSound")
    {
      ...
      mFormat = 1;
      mTrack[0] = new AGITrack(this);
      mTrack[1] = new AGITrack(this);
      mTrack[2] = new AGITrack(this);
      mTrack[3] = new AGITrack(this);
    ...
    public AGITrack this[int index]
    {
      get
      {
        return Track(index);
    ...
    public AGITrack Track(int Index)
    {
      //validate index
      if (Index< 0 || Index> 3)
      {
    ...
    public override void Load()
    {
      ...
      if (!InGame)
      {//TODO- not true! nongame resources certainly can be unloaded and loaded;
