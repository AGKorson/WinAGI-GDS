...
{
  public class InventoryObjects : IEnumerable<InventoryItem>
  {
    ...
    public InventoryObjects(AGIGame parent, bool Loaded = false) 
    {
      this.parent = parent;
      mInGame = true;
...
ErrHandler:
  ...
  throw new Exception("582, strErrSource, LoadResString(582)
    ...
    public void SetObjects(InventoryObjects NewObjects)
    {
