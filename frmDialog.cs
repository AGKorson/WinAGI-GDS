...
namespace WinAGI.Editor {
    internal partial class frmDialog : Form {
        ...
        internal frmDialog(Form owner, string Prompt, string Title, MessageBoxButtons Buttons, MessageBoxIcon Icon, string CheckString, ref bool Checked, string HelpFile, string HelpTopic) {
            ...
            buttonWidth = Width - ClientSize.Width;
            ...
            int width = buttonWidth + Message.Left + Message.Width + 14;
            if (width < buttonCount * (button1.Width + 6) + buttonWidth + 6) {
                width = buttonCount * (button1.Width + 6) + buttonWidth + 6;
            }
            ...
            button1.Left = ClientSize.Width - buttonCount * (button1.Width + 6);
