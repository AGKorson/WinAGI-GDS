    ...
    public partial class frmGameProperties : Form {
        ...
        private void btnOK_Click(object sender, EventArgs e) {
            ...
            if (DisplayDir.Length == 0) {
                MessageBox.Show(MDIMain,
                    "Choose a directory for this new game.",
                    "New Game",
        ...
        private void optNAGI_CheckedChanged(object sender, EventArgs e) {
            if (optNAGI.Checked) {
                ...
                NewPlatformFile = Path.Combine(EditGame.GameDir, "n.exe");
        ...
        private void optAGILE_CheckedChanged(object sender, EventArgs e) {
            if (optAGILE.Checked) {
                // dir and options are allowed for agile
                lblPlatformFile.Enabled = true;
                btnPlatformFile.Enabled = true;
                txtPlatformFile.Enabled = true;
                lblOptions.Enabled = true;
        ...
        private void SetForm(GameSettingFunction mode) {
            ...
            case GameSettingFunction.Edit:
                ...
                txtDesigner.Text = EditGame.Designer;
                txtGameVersion.Text = EditGame.GameVersion;
                txtGameAbout.Text = EditGame.GameAbout;
                txtGameDescription.Text = EditGame.Description;

                // version
                cmbVersion.SelectedIndex = (int)EditGame.InterpreterVersion.Index;
            ...
            case GameSettingFunction.New:
                ...
                txtGameAbout.Text = "AGI Game by <designer>";
        ...
        private void ChangeDisplayGameDir() {
            ...
            if (MDIMain.FolderDlg.ShowDialog() == DialogResult.OK) {
                DisplayDir = MDIMain.FolderDlg.SelectedPath;
                txtGameDir.Text = DisplayDir;
                BrowserStartDir = DisplayDir;
            }
            btnOK.Enabled = (txtGameID.TextLength > 0 && DisplayDir.Length > 0);
        ...
        private void ShowHelp() {
            ...
            case "General":
                topic = "htm\\winagi\\prop_general.htm";
                break;
            case "Version":
                topic = "htm\\winagi\\prop_version.htm";
                break;
            case "Platform":
                topic = "htm\\winagi\\prop_platform.htm";
                break;
            case "Advanced":
                topic = "htm\\winagi\\prop_advanced.htm";
                break;
            }

            if (ActiveControl is not null) {
                if (ActiveControl.Tag is string subtopic) {
                    topic += "#" + subtopic;
                }
            }
