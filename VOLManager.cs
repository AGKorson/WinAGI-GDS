...
//      If FileLen(agGameDir & strID & "VOL." & CStr(i)) + NewResource.Size<agMaxVolSize Then
...
//  If lngCurrentLoc + ResSize > agMaxVolSize Or(lngCurrentVol = 0 And (lngCurrentLoc + ResSize > agMaxVol0)) Then
...
//      If(i > 0 And LOF(intVolFile) + ResSize <= agMaxVolSize) Or((LOF(intVolFile) + ResSize <= agMaxVol0)) Then
