...
namespace WinAGI.Editor {
    public partial class frmEditResourceProperties : Form {
        ...
        private void frmEditResourceProperties_HelpRequested(object sender, HelpEventArgs hlpevent) {
            Help.ShowHelp(HelpParent, WinAGIHelp, "htm\\winagi\\managingresources.htm#editing");
