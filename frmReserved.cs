...
namespace WinAGI.Editor {
    public partial class frmReserved : Form {
        ...
        private void frmReserved_HelpRequested(object sender, HelpEventArgs hlpevent) {
            string topic = @"htm\winagi\reservednames.htm#editor";
            ...
            if (EditGame is not null) {
                ...
                case AskOption.Ask:
                    ...
                    rtn = MsgBoxEx.Show(MDIMain,
                        ...
                        "Always take this action when saving the reserved defines list.", ref dontAsk,
        ...
        private void btnReset_Click(object sender, EventArgs e) {
            for (int i = 0; i < reservedgrid.Rows.Count; i++) {
                ...
                ResDefGroup group = (ResDefGroup)reservedgrid[0, i].Tag;
                int index = (int)reservedgrid[1, i].Tag;
                if ((string)reservedgrid[0, i].Value != EditList.ByGroup(group)[index].DefaultName) {
                    reservedgrid[0, i].Value = EditList.ByGroup(group)[index].DefaultName;
                }
            }
        ...
        private void reservedgrid_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e) {
            ...
            if ((string)reservedgrid[0, e.RowIndex].Value != EditList.ByGroup(group)[index].DefaultName) {
        ...
        private void reservedgrid_CellValidated(object sender, DataGridViewCellEventArgs e) {
            ...
            if (reservedgrid.IsCurrentCellInEditMode) {
                ...
                if (string.IsNullOrEmpty((string)reservedgrid[0, e.RowIndex].Value)) {
                    reservedgrid[0, e.RowIndex].Value = EditList.ByGroup((ResDefGroup)reservedgrid[0, e.RowIndex].Tag)[(int)reservedgrid[1, e.RowIndex].Tag].DefaultName;
                }
            }
        }
        ...
        private void cmReset_Click(object sender, EventArgs e) {
            ...
            if ((string)reservedgrid[0, reservedgrid.CurrentRow.Index].Value != EditList.ByGroup((ResDefGroup)reservedgrid[0, reservedgrid.CurrentRow.Index].Tag)[(int)reservedgrid[1, reservedgrid.CurrentRow.Index].Tag].DefaultName) {
                reservedgrid[0, reservedgrid.CurrentRow.Index].Value = EditList.ByGroup((ResDefGroup)reservedgrid[0, reservedgrid.CurrentRow.Index].Tag)[(int)reservedgrid[1, reservedgrid.CurrentRow.Index].Tag].DefaultName;
                btnSave.Enabled = true;
            }
        }
        ...
        private void contextMenuStrip1_Opening(object sender, CancelEventArgs e) {
            ...
            cmReset.Enabled = (string)reservedgrid[0, reservedgrid.CurrentRow.Index].Value != EditList.ByGroup((ResDefGroup)reservedgrid[0, reservedgrid.CurrentRow.Index].Tag)[(int)reservedgrid[1, reservedgrid.CurrentRow.Index].Tag].DefaultName;
        }
        #endregion
        ...
        private void LoadGrid(ReservedDefineList gridlist) {
            ...
            for (int i = 0; i < tmpDefines.Length; i++) {
                ...
                if (tmpDefines[i].Name != tmpDefines[i].DefaultName) {
                    modified = true;
                }
