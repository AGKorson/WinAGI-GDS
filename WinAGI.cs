...
namespace WinAGI
{
  ...
  ***************************************************************/
  ...
  internal static partial class WinAGI
  {
    ...
    internal static string[] ResTypeAbbrv = { "LOG", "PIC", "VIEW", "SND" };
    internal static string[] agResTypeName = { "Logic", "Picture", "View", "Sound" };
    internal static string[] agVersion = new string[16]; //15; // (2.917, etc)
