...
namespace WinAGI.Engine {
    ...
    public class Picture : AGIResource {
        ...
        /// <summary>
        /// Gets or set target interpreter version. Needed for the plot commands.
        /// </summary>
        public AGIVersion Version {
            get {
                if (parent is not null) {
                    return parent.InterpreterVersion.Index;
                }
                else {
                    return mVersion;
                }
        ...
        /// <summary>
        /// Gets or sets the stopping position to use when drawing the picture.
        /// </summary>
        public int DrawPos {
            get {
                WinAGIException.ThrowIfNotLoaded(this);
        ...
        public void SaveProps() {
            if (mInGame) {
                string section = "Picture" + mResNum;
                parent.WriteGameSetting(section, "ID", mResID, "Pictures");
                parent.WriteGameSetting(section, "Description", mDescription);
                if (mPriBase != 48) {
                    parent.WriteGameSetting(section, "PriBase", mPriBase.ToString());
                }
                else {
                    parent.agGameProps.DeleteKey(section, "PriBase");
                }
                // if no bkgdfile, delete other settings
                if (mBkgdSettings.FileName.Length == 0) {
                    mBkgdSettings = new();
                    parent.agGameProps.DeleteKey(section, "BkgdImgFile");
                    parent.agGameProps.DeleteKey(section, "BkgdVisible");
                    parent.agGameProps.DeleteKey(section, "BkgdShowVis");
                    parent.agGameProps.DeleteKey(section, "BkgdShowPri");
                    parent.agGameProps.DeleteKey(section, "BkgdTrans");
                    parent.agGameProps.DeleteKey(section, "BkgdDefaultTrans");
                    parent.agGameProps.DeleteKey(section, "BkgdSrcX");
                    parent.agGameProps.DeleteKey(section, "BkgdSrcY");
                    parent.agGameProps.DeleteKey(section, "BkgdSrcW");
                    parent.agGameProps.DeleteKey(section, "BkgdSrcH");
                    parent.agGameProps.DeleteKey(section, "BkgdSizeW");
                    parent.agGameProps.DeleteKey(section, "BkgdSizeH");
                    parent.agGameProps.DeleteKey(section, "BkgdTgtX");
                    parent.agGameProps.DeleteKey(section, "BkgdTgtY");

                }
                else {
                    parent.WriteGameSetting(section, "BkgdImgFile", mBkgdSettings.FileName);
                    parent.WriteGameSetting(section, "BkgdVisible", mBkgdSettings.Visible);
                    parent.WriteGameSetting(section, "BkgdShowVis", mBkgdSettings.ShowVis);
                    parent.WriteGameSetting(section, "BkgdShowPri", mBkgdSettings.ShowPri);
                    parent.WriteGameSetting(section, "BkgdTrans", mBkgdSettings.Transparency);
                    parent.WriteGameSetting(section, "BkgdDefaultTrans", mBkgdSettings.DefaultAlwaysTransparent);
                    parent.WriteGameSetting(section, "BkgdSrcX", mBkgdSettings.SourceRegion.X);
                    parent.WriteGameSetting(section, "BkgdSrcY", mBkgdSettings.SourceRegion.Y);
                    parent.WriteGameSetting(section, "BkgdSrcW", mBkgdSettings.SourceRegion.Width);
                    parent.WriteGameSetting(section, "BkgdSrcH", mBkgdSettings.SourceRegion.Height);
                    parent.WriteGameSetting(section, "BkgdTgtX", mBkgdSettings.TargetPos.X);
                    parent.WriteGameSetting(section, "BkgdTgtY", mBkgdSettings.TargetPos.Y);
                    parent.WriteGameSetting(section, "BkgdSizeW", mBkgdSettings.SourceSize.Width);
                    parent.WriteGameSetting(section, "BkgdSizeH", mBkgdSettings.SourceSize.Height);
                }
            ...
            try {
                while (pos <= statuspos) {
                    ...
                    case 0xFA:
                        ...
                        while (mData[pos] < 0xF0) {
                            pos++;
                        }
                        bytevalue = mData[pos++];
                        break;
                    case 0xF9:
                        // Change pen size and style (only if NOT a v2.089,
                        // v2.272 or 2.411 picture)
                        bytevalue = mData[pos++];
                        if (mVersion > AGIVersion.v2411) {
